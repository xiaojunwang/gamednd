...
var House = function House(props) {
  return __jsx("div", {
    ...
    __self: this
  }, props.dada.title)), __jsx("img", {
    src: props.dada.picture,
    width: "50%",
    alt: "House picture",
    __source: {
      fileName: _jsxFileName,
    ...
    __self: this
  }, props.dada.type, " - ", props.dada.town), __jsx("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13
    },
    __self: this
  }, props.dada.title), __jsx("p", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 14
    },
    __self: this
  }, props.dada.rating, " (", props.dada.reviewsCount, ")"));
};
...
House.getInitialProps = function (_ref) {
  ...
  var id = query.id;
  return {
    dada: _houses_json__WEBPACK_IMPORTED_MODULE_2__.filter(function (house) {
      return house.id === id;
    })[0]
  };
};
...
//# sourceMappingURL=[id].js.3246efcf42c2e0ba4a66.hot-update.js.map